    ...
    <form action="{{ route('control.events.update', ['event' => $event->id]) }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="row">
        ...
        <div class="mb-3 col-12 col-lg-6">
          ...
          <input type="text" name="card_text" id="card_text" class="form-control" value="{{ old('card_text', $event->card_text) }}">
          @error('card_text')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
        ...
        <div class="mb-3 col-12 col-lg-6 d-flex align-items-end">
          <div class="form-check form-switch d-flex gap-2 align-items-center" style="height: 38px">
            <input class="form-check-input" type="checkbox" role="switch" id="show_date" name="show_date" @checked(old('show_date', $event->show_date))>
